...
public class Main  extends DriverExam{

	public Main(char[] answers) {
		super(answers);
...
//		DriverExam exam = new DriverExam(answersListModel);
		...
		DriverExam exam = mapper.getAllDriverExam();
		
		 DefaultListModel<String> responsesListModel = new DefaultListModel<String>();
